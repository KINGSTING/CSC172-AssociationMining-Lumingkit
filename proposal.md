...
### Sample Transactions (Conceptual View)
The table below illustrates how raw network logs are viewed as "transactions" for the Apriori algorithm. Note how continuous variables (like duration) are "binned" into categories to serve as items.

| Trans ID | Protocol |	Service	| Flag |	Duration (Binned) |	Class (Label) |
| :--- |  :--- |  :--- |  :--- |  :--- |  :--- | 
|Trx_001 |  TCP |  http |  SF |  Zero |  Normal | 
|Trx_002 |  TCP |  private |  S0 |  Zero |  Neptune (DoS) | 
| Trx_003 |  ICMP |  ecr_i |  SF |  Zero |  Smurf (DoS) | 
| Trx_004 |  TCP |  telnet|  RSTR |  Short |  Guess_Passwd (R2L) | 
| Trx_005 |  UDP |  domain_u |  SF |  Zero |  Normal | 
